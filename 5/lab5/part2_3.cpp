...
void RBG_2_Gray_Conversion(char *II, int pid, int pipefds[2], int pipefds2[2]){
    ...
    // update rgb values to make grayscale
    for (int i = 0; i < height; i++)
    {
        for (int j = 0; j < width; j++)
        {
            ...
            arrayOfData[i][j].r = (arrayOfData_red * 0.3) + (arrayOfData_green * 0.59) + (arrayOfData_blue * 0.11);
            arrayOfData[i][j].g = (arrayOfData_red * 0.3) + (arrayOfData_green * 0.59) + (arrayOfData_blue * 0.11);
            arrayOfData[i][j].b = (arrayOfData_red * 0.3) + (arrayOfData_green * 0.59) + (arrayOfData_blue * 0.11);
        }
    }
